...
*/
const BotName = '🤖F3RD1Bot🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ferdi_ardian21'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+6282169369877'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/GQRkuhH34C80Y6JWwG3xXl'; // OFFICIAL GRUP LU 1
const grupch2 = 'Nothing'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://instagram.com/ferdi_ardian21'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] F3RD1Bot By Ferdi Ardian Ready Scan Now!`);
});
...
conn.sendMessage(id, 'Owner wa.me/+6282168369877' ,MessageType.text);
}
else if (text == '$creator'){
conn.sendMessage(id, 'Creator wa.me/+6282169369877' ,MessageType.text);
}
else if (text == 'Fer'){
conn.sendMessage(id, 'Aku SYG nya Ferdi' ,MessageType.text);
}
